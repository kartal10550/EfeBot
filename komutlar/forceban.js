           ...
           .then(bans => {
               ...
               message.guild.members.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> adlı kullanıcı banlandı <a:sunglasses:816708209846517781>`);
                   })
                   .catch(error => {
           ...
           .then(bans => {
               ...
               message.guild.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> sunucudan yasaklandı <a:sunglasses:816708209846517781>`);
                   })
                   .catch(error => {
